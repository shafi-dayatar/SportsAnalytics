...
//
//    }
    public void startMeasurement(String command) {
        if("EMG".equals(command)) {
            if (mBluetoothGatt == null ||
                    !mMyoCallback.setMyoControlCommand(commandList.sendEmgOnly())) {
                Log.d(TAG, "Error start EMG measurment");
        ...
        } else if("IMU".equals(command)) {
            if (mBluetoothGatt == null ||
                    !mMyoCallback.setMyoControlCommand(commandList.sendImuOnly())) {
