...
public:
	...
	void openFiles() {
		...
		std::ostringstream dir << "myo-data/";
		std::ostringstream emgFileString;
		emgFileString << dir << "emg-" << timestamp << ".csv";
		...
		gyroFileString << dir  << "gyro-" << timestamp << ".csv";
		...
		accelerometerFile  << dir << "timestamp,x,y,z" << std::endl;
		...
		orientationFile << dir << "timestamp,x,y,z,w" << std::endl;
		...
		orientationEulerFile << dir << "timestamp,roll,pitch,yaw" << std::endl;
