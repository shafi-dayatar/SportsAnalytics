...
public class GameController {
	...
	public ResponseEntity<?> startGame(@RequestBody Player requestPlayer){
		
		Player player = authenticateService.getPlayer(requestPlayer.getEmailid());
		if(player == null) {
			ApiResponse response = new ApiResponse();
		...
		Game gameId = gameService.startGame(requestPlayer.getEmailid());		
